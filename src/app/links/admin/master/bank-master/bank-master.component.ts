...
import { BankMasterService, BankData, AddBankModel } from '../../../../services/bank-master.service';
...
export class BankMasterComponent {
  ...
  public ELEMENT_DATA: BankData[] = [];
  public dataSource = new MatTableDataSource<BankData>(this.ELEMENT_DATA);
  public snackBar = {
    message: '',
    show: false
  }
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.dataSource = new MatTableDataSource<BankData>(this.ELEMENT_DATA);
  }
